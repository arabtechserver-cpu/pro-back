...
async function run() {
  const realServiceId = '1477000001';
  await testDhru('placeimeiorder', { 'SERVICEID': realServiceId, 'IMEI': '123456789012345' });
  await testDhru('placeimeiorder', { 'ID': realServiceId, 'IMEI': '123456789012345' });
}
run();
