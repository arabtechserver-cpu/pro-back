...
exports.addContactToLoops = exports.sendOtpEmailViaLoops = void 0;
const https_1 = __importDefault(require("https"));
const LOOPS_API_KEY = process.env.LOOPS_API_KEY || "c54fb8a81230d2f9432530b5fdf9ac4b";
 ...
 */
const sendOtpEmailViaLoops = (email, payload) => {
...
exports.sendOtpEmailViaLoops = sendOtpEmailViaLoops;
/**
 * Add a contact to Loops.so Audience
 */
const addContactToLoops = (email, firstName) => {
    return new Promise((resolve) => {
        const postData = JSON.stringify({
            email: email.trim().toLowerCase(),
...
exports.addContactToLoops = addContactToLoops;
